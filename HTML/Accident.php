...
$query = "SELECT * FROM LightStates WHERE PatternName = 'AccidentTraffic'";
	...
	<ul>
		<li class="expand"><h2>Eastern Intersection </h2><i class="fa fa-chevron-down" aria-hidden="true"></i>
			<ul>
				...
				<li><a href="http://localhost:8888/HTML/CreateNew.php"><h3>Create New Traffic</h3></a></li>
			</ul>
...
<div class="mainSection">   
	<h1>Accident Traffic Pattern</h1>
